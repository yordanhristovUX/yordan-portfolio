  ...
  return (
    <>
      ...
      <main id="top" className="sheet">
        ...
        {/* ============ 01 · RESULTS ============ */}
        <SectionHead id="results" className="band sec" aria-labelledby="results-title">
          <SectionHeadHead className="sec__head">
            <SectionHeadTitle id="results-title" className="t-title">
              Results
            </SectionHeadTitle>
            <SectionHeadNote>Regenerated by evals/run.mjs on every run</SectionHeadNote>
          </SectionHeadHead>
          <div className="well">
        ...
        {/* ============ 02 · METHOD ============ */}
        <SectionHead id="method" className="band sec" aria-labelledby="method-title">
          <SectionHeadHead className="sec__head">
            <SectionHeadTitle id="method-title" className="t-title">
              Method
            </SectionHeadTitle>
            <SectionHeadNote>Offline, free, no API key, runs in CI</SectionHeadNote>
          </SectionHeadHead>
          <div className="well">
            <div className="ev-prose">
              <p>
        ...
        <SectionHead id="classes" className="band sec" aria-labelledby="classes-title">
          <SectionHeadHead className="sec__head">
            <SectionHeadTitle id="classes-title" className="t-title">
              By question class
            </SectionHeadTitle>
            <SectionHeadNote>hit@3, except abstention classes</SectionHeadNote>
          </SectionHeadHead>
          <div className="well">
        ...
        <SectionHead variant="tint" id="reading" className="band sec" aria-labelledby="reading-title">
          <SectionHeadHead className="sec__head">
            <SectionHeadTitle id="reading-title" className="t-title">
              Reading the numbers
            </SectionHeadTitle>
            <SectionHeadNote>Including the parts that went badly</SectionHeadNote>
          </SectionHeadHead>
          <div className="well">
        ...
        {/* ============ 05 · THE CORPUS ============ */}
        <SectionHead id="corpus" className="band sec" aria-labelledby="corpus-title">
          <SectionHeadHead className="sec__head">
            <SectionHeadTitle id="corpus-title" className="t-title">
              The corpus
            </SectionHeadTitle>
            <SectionHeadNote>Generated from content/, never hand-written</SectionHeadNote>
          </SectionHeadHead>
          <div className="well">
