  ...
  "portfolio-system": {
    ...
    content: `
      ...
      <ul>
        ...
        <li><strong>83 tokens, 142 values, 20 components</strong> — one token carries its light, dark and print values together; each component is enforced as CSS + AI spec + story by the build.</li>
